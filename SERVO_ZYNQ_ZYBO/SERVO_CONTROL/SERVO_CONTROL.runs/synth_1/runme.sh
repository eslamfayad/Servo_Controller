...
HD_PWD='D:/MASTER_2021/ADVANCED_VLSI/Verilog_Programs/SERVO_CONTROL/Servo_Controller_Verilog/SERVO_ZYNQ_ZYBO/SERVO_CONTROL/SERVO_CONTROL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Servo_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Servo_2.tcl
